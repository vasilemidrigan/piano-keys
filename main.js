// The keys and notes variables that stores the piano keys
...
// A function that changes the background color of the piano keys when they
//  are clicked
const eventCall = (note) => {
  note.addEventListener('mousedown', keyPlay);
  note.addEventListener('mouseup', keyReturn);
}
// A forEach method that runs the array elements through the function
